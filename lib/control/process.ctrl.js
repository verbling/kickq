...
Process.prototype._startWorking = function( job ) {

  // invocation params: ghostTimeout
  ...
  // resolve callback type and partial it with the job item
