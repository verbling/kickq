...
metricsModel.on('metrics', metrics.emit.bind(metrics, 'metrics'));
 ...
 * @private
 */
metrics.metrics._vitalsStart = function(){
  if (vitalsOn) {return;}
  vitalsOn = true;
 ...
 * @private
 */
metrics.metrics._vitalsStop = function(){
  if (!vitalsOn) {return;}
  vitalsOn = false;
 ...
 * @private
 */
metrics.metrics._metricsStart = function(){
  if (metricsOn) {return;}
  metricsOn = true;
 ...
 * @private
 */
metrics.metrics._metricsStop = function(){
  if (!metricsOn) {return;}
  metricsOn = false;
