...
Metrics.prototype.start = function() {
  ...
  this.channels.forEach(this.clientSub.subscribe.bind(this));
};
...
Metrics.prototype.stop = function() {
  ...
  this.channels.forEach(this.clientSub.unsubscribe.bind(this));
...
Metrics.prototype._onMessage = function(channel, message) {
  ...
  this.emit(channel, channel, publicJobItem);
};
