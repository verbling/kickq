...
Hotjob.prototype.check = function() {
  ...
  this.subKeySuccess = this.NS + ':complete:' + this.job.name;
  this.subKeyFail = this.NS + ':fail:' + this.job.name;

  this.client.on('message', this._onMessage.bind(this));
  this.client.subscribe(this.subKeySuccess);
  this.client.subscribe(this.subKeyFail);
...
Hotjob.prototype._complete = function(err, publicJobItem) {
  ...
  this._timeout = null;
  this.client.unsubscribe(this.subKeySuccess);
  this.client.unsubscribe(this.subKeyFail);
  this.client.quit();
