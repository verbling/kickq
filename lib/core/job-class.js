/**
 * @fileoverview The internal job object.
 */
 ...
 * @constructor
 */
var JobK = module.exports = function() {
   ...
   *
   * @type {Array.<JobK.ProcessItem>} An array of process items.
   */
  this.runs = [];
};
 ...
 * @constructor
 */
JobK.ProcessItem = function(optCount) {
  ...
  /**
   * Same as JobK.state except states: 'new', 'delayed', 'retrying'
   * @type {string}
   */
